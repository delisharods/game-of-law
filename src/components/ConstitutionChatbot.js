...
export default function ConstitutionChatbot() {
  ...
  const sendMessage = async (text) => {
    ...
    try {
      ...
      setMessages((prev) => [
        ...prev,
        { role: "assistant", content: "⚠️ Unable to connect right now. Please make sure the backend is running and try again." },
      ]);
    } finally {
      setLoading(false);
    }
          ...
          <div className="samvidhan-messages">
            {showWelcome && (
              <div className="welcome-card">
                ...
                <p>Ask me anything about the Indian Constitution — Articles, Fundamental Rights, Amendments & more.</p>
